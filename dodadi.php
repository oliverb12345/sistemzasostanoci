...
$datum = mysqli_real_escape_string($conn,$_POST['datum1']); 
$vreme = mysqli_real_escape_string($conn,$_POST['vreme1']); 
$pokaneti = mysqli_real_escape_string($conn,$_POST['pokaneti1']);

$sql = "INSERT INTO sostanoci (datum, vreme, pokaneti)
VALUES ('$datum', '$vreme', '$pokaneti')";

if ($conn->query($sql) === TRUE) {
    $test = "Успешно додаден нов состанок";
} else {
